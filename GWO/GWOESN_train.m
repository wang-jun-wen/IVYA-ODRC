function net=GWOESN_train(indata, outdata, initLen, trainLen,reg,a,SR,b,resSize,W,Win)
...
Yt = outdata(initLen+2:trainLen+1,:)';           %4*2500 一列代表一个个体。2500个个体
...
Wout = Yt*Xpr_T / (Xpr*Xpr_T + reg*eye(3*resSize));
