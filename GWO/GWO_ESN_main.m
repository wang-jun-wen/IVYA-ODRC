...
%% 自己本机的地址
%save('C:\Users\wangjunwen\Desktop\article2\code\MCSs\curve\GWO_curve.mat', 'curve');
%save('C:\Users\wangjunwen\Desktop\article2\code\MCSs\Best_pos\GWO_pos.mat', 'Best_pos');

%% 服务器上的地址
save('/home/user/Desktop/article2/code/MCSs/curve/GWO_curve.mat', 'curve');
save('/home/user/Desktop/article2/code/MCSs/Best_pos/GWO_pos.mat', 'Best_pos');
%% 在后面的指定位置打上结束时间标注
...
%% 保存时间信息
save('/home/user/Desktop/article2/code/MCSs/time/GWO_time.mat', 'elapsed_time');
%% 获得了最优的参数
