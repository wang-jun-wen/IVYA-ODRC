...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Destination_fitness,Destination_position,Convergence_curve]=IVY(N,Max_iteration,lb,ub,dim,data_group,start_time)
...
for i = 1:numel(pop)
    ...
    % Evaluation
    pop(i).Cost = getfitness_average(pop(i).Position,data_group);
...
for it = 1:MaxIt
    ...
    for i = 1:numel(pop)
        ...
        newsol.Cost = getfitness_average(newsol.Position,data_group);
    ...
    disp(['current iteration is: ',num2str(it), ', best fitness is: ', num2str(BestCosts(it))]);
